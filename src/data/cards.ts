...
export const CARD_DEFS: CardDef[] = [
  ...
  },
  {
    ...
    name: "助っ人ネイティブ",
    keepValue: 8,
    useEffect: { selfBonus: 12 },
    description: "外国語授業にネイティブを召喚し、12単位を得る。",
    category: "stable",
  },
  {
    id: "suwarikomi",
  ...
  },
  {
    ...
    name: "計画的昼寝",
    keepValue: 10,
    useEffect: { selfBonus: 6, drawCards: 1 },
    description: "午後の授業をサボり、6単位を得る。1枚ドローする。",
    category: "minus",
  },
  {
    id: "enjo",
  ...
  },
  {
    ...
    description: "限界でも全休を作るべく履中し、0単位を得る。手札1枚を除外し、相手のカードを1枚捨てる。",
    category: "chaos",
  },
  {
    id: "grade_hack",
